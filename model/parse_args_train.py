...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='ET-DSC')
    # choose model
    parser.add_argument('--model', type=str, default='ET-DSC')
    # parameter for ET-DSC
    ...
    parser.add_argument('--dataset', type=str, default='NUDT-SIRST',
                        help='dataset name:  NUDT-SIRST, NUAA-SIRST')
