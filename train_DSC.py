...
from model.model_ET_DSC import DNANet
# from model.TTOA_CNN import *
...
class Trainer(object):
    def __init__(self, args):
        ...
        input_transform = transforms.Compose([
            ...
            # transforms.RandomVerticalFlip(p=0.5),  # 可选：随机垂直翻转
            # transforms.RandomResizedCrop(size=args.crop_size,  # 随机裁剪到指定大小
            #                              scale=(0.8, 1.2),
            #                              ratio=(0.75, 1.33)),
            # RandomGaussianBlur(p=0.5),  # 自定义随机高斯模糊
            transforms.ToTensor(),
